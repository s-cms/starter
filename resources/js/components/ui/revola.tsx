  ...
  compoundVariants: [
    {
      ...
      direction: "bottom",
      className:
        "inset-x-0 bottom-0 mt-24 h-fit max-h-[65%] flex-col rounded-t-[10px] border border-primary/10 border-b-0",
    },
    {
      device: "mobile",
      direction: "top",
      className:
        "inset-x-0 top-0 mb-24 h-fit max-h-[65%] flex-col rounded-b-[10px] border border-primary/10 border-b-0",
    },
    {
      device: "mobile",
      direction: "left",
